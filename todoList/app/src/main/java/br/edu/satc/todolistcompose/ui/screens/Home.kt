...
import br.edu.satc.todolistcompose.TaskViewModel
import br.edu.satc.todolistcompose.TaskViewModelFactory
...
fun HomeScreen() {
    ...
    Scaffold(
        ...
        NewTask(showBottomSheet = showBottomSheet, onComplete = { showBottomSheet = false }, viewModel = viewModel)
